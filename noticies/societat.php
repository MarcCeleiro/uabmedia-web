							...
							<div>    
								<div data-aos="zoom-in" class="row">
									...
									<div class="col-12 col-md-4">
										<div class="bloc-imatges position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_societat->list[$i]->id; ?>/<?php echo $data_societat->list[$i]->title_url; ?>'">
