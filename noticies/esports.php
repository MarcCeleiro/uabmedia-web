...
<html lang="ca">
	...
	<head>
		...
		<title>Notícies d'Esports - Actualitat - UABmèdia</title>
		...
		<meta name="twitter:url" content="https://uab.media/noticies/esports">
		<meta property="og:site_name" content="UABmèdia" />
		<meta property="og:url" content="https://uab.media/noticies/esports" />
		...
		<link rel="canonical" href="https://uab.media/noticies/esports">
					...
					<div class="row">
						<div class="col-12 overflow-hidden amaga-mobil">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="titol-principal titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies d'esports</h1>
							</div>
						</div>
						<section> 
							<div class="container">
												...
												<ul class="navbar-nav">
													...
													<li class="nav-item dropdown" style="margin-right: 20px">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
															...
															<a class="dropdown-item" href="https://uab.media/noticies/universitat-autonoma">Autònoma</a>
							...
							<section>
								...
								<div>    
									<div data-aos="zoom-in" class="row">
										...
										?>
							<a class="col-12 col-md-4 noticia-petita" href="/noticia/<?php echo $data_esports->list[$i]->id; ?>/<?php echo $data_esports->list[$i]->title_url; ?>">
								<img class="imatge-destacada" src="<?php echo $data_esports->list[$i]->img_poster; ?>" alt="<?php echo $data_esports->list[$i]->title; ?>">
								<div class="contingut-noticia">
									<h2 class="titol"><?php echo $data_esports->list[$i]->title; ?></h2>
									<p class="data"><?php echo substr($data_esports->list[$i]->date_formatted, 0, -9); ?></p>
								</div>
							</a>
							<?php } ?>
									</div>		
