...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="bloc-imatges position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_centenari->list[$i]->id; ?>/<?php echo $data_centenari->list[$i]->title_url; ?>'">
