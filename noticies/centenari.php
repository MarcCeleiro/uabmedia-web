					...
					<div class="row">
						<div class="col-12 overflow-hidden hide-mobile">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="main-title titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies de Centenari de la Ràdio</h1>
							</div>
						</div>
						<section> 
							<div class="container">
...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="block-images position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_centenari->list[$i]->id; ?>/<?php echo $data_centenari->list[$i]->title_url; ?>'">
									<div class="img-noticia noticia_flex" style="background-image:url(<?php echo $data_centenari->list[$i]->img_social; ?>)">
									</div>
								</div>
								<br />
								<h2 class="titol h6"><a href="/noticia/<?php echo $data_centenari->list[$i]->id; ?>/<?php echo $data_centenari->list[$i]->title_url; ?>"><?php echo $data_centenari->list[$i]->title; ?></a></h2>
								<div class="capitol d-flex align-items-center my-2">
									<span class="text-white"><?php echo substr($data_centenari->list[$i]->date_formatted, 0, -9); ?></span>
								</div>
								<br /><br />
							</div>
							<?php } ?>
