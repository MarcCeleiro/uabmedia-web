...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							?>
							<a class="col-12 col-md-4 noticia-petita" href="/noticia/<?php echo $data_tecnologia->list[$i]->id; ?>/<?php echo $data_tecnologia->list[$i]->title_url; ?>">
								<img class="imatge-destacada" src="<?php echo $data_tecnologia->list[$i]->img_poster; ?>" alt="<?php echo $data_tecnologia->list[$i]->title; ?>">
								<div class="contingut-noticia">
									<h2 class="titol"><?php echo $data_tecnologia->list[$i]->title; ?></h2>
									<p class="data"><?php echo substr($data_tecnologia->list[$i]->date_formatted, 0, -9); ?></p>
								</div>
							</a>
							<?php } ?>
						</div>		
