					...
					<div class="row">
						<div class="col-12 overflow-hidden amaga-mobil">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="titol-principal titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Informatius</h1>
							</div>
						</div>
						<section> 
							<div class="container">
...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="bloc-imatges position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_informatius->list[$i]->id; ?>/<?php echo $data_informatius->list[$i]->title_url; ?>'">
									<div class="img-noticia noticia_flex" style="background-image:url(<?php echo $data_informatius->list[$i]->img_social; ?>)">
									</div>
								</div>
								<br />
								<h2 class="titol h6"><a href="/noticia/<?php echo $data_informatius->list[$i]->id; ?>/<?php echo $data_informatius->list[$i]->title_url; ?>"><?php echo $data_informatius->list[$i]->title; ?></a></h2>
								<div class="capitol d-flex align-items-center my-2">
									<span class="text-white"><?php echo substr($data_informatius->list[$i]->date_formatted, 0, -9); ?></span>
								</div>
								<br /><br />
							</div>
							<?php } ?>
