					...
					<div>
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								...
								<br />
								<h6 class="titol"><a href="/noticia/<?php echo $data_informatius->list[$i]->id; ?>/<?php echo $data_informatius->list[$i]->title_url; ?>"><?php echo $data_informatius->list[$i]->title; ?></a></h6>
