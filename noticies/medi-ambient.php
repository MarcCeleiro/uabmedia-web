					...
					<div class="row">
						<div class="col-12 overflow-hidden hide-mobile">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="main-title titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies de Medi Ambient i Sostenibilitat</h1>
							</div>
						</div>
						<section> 
							<div class="container">
					...
					<div>
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="block-images position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_mediambient->list[$i]->id; ?>/<?php echo $data_mediambient->list[$i]->title_url; ?>'">
									<div class="img-noticia noticia_flex" style="background-image:url(<?php echo $data_mediambient->list[$i]->img_social; ?>)">
									</div>
								</div>
								<br />
								<h6 class="titol"><a href="/noticia/<?php echo $data_mediambient->list[$i]->id; ?>/<?php echo $data_mediambient->list[$i]->title_url; ?>"><?php echo $data_mediambient->list[$i]->title; ?></a></h6>
