				...
				<section id="header">
					<div class="row">
						<div class="col-12 overflow-hidden amaga-mobil">
							<h1 class="titol-pagina">Notícies de Medi Ambient i Sostenibilitat</h1>
						</div>
						<section> 
							<div class="container">
								<div class="row">
...
<div data-aos="zoom-in" class="row">
							...
							?>
							<a class="col-12 col-md-4 noticia-petita" href="/noticia/<?php echo $data_mediambient->list[$i]->id; ?>/<?php echo $data_mediambient->list[$i]->title_url; ?>">
								<img class="imatge-destacada" src="<?php echo $data_mediambient->list[$i]->img_poster; ?>" alt="<?php echo $data_mediambient->list[$i]->title; ?>">
								<div class="contingut-noticia">
									<h2 class="titol"><?php echo $data_mediambient->list[$i]->title; ?></h2>
									<p class="data"><?php echo substr($data_mediambient->list[$i]->date_formatted, 0, -9); ?></p>
								</div>
							</a>
							<?php } ?>
						</div>		
