					...
					<div class="row">
						<div class="col-12 overflow-hidden hide-mobile">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="main-title titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies d'Igualtat</h1>
							</div>
						</div>
						<section> 
							<div class="container">
...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="block-images position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_igualtat->list[$i]->id; ?>/<?php echo $data_igualtat->list[$i]->title_url; ?>'">
