...
<html lang="ca">
	...
	<head>
		...
		<title>Notícies de Cultura i Mitjans - Actualitat - UABmèdia</title>
					...
					<div class="row">
						<div class="col-12 overflow-hidden amaga-mobil">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="titol-principal titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies de Cultura i Mitjans</h1>
							</div>
						</div>
						<section> 
							<div class="container">
...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							for ($i = 0; $i < count($data_ciencia->list); $i++) {
							?>
							<a class="col-12 col-md-4 noticia-petita" href="/noticia/<?php echo $data_ciencia->list[$i]->id; ?>/<?php echo $data_ciencia->list[$i]->title_url; ?>">
								<img class="imatge-destacada" src="<?php echo $data_ciencia->list[$i]->img_poster; ?>" alt="<?php echo $data_ciencia->list[$i]->title; ?>">
								<div class="contingut-noticia">
									<h2 class="titol"><?php echo $data_ciencia->list[$i]->title; ?></h2>
									<p class="data"><?php echo substr($data_ciencia->list[$i]->date_formatted, 0, -9); ?></p>
								</div>
							</a>
							<?php } ?>
						</div>		
