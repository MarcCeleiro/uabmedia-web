...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="bloc-imatges position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_ciencia->list[$i]->id; ?>/<?php echo $data_ciencia->list[$i]->title_url; ?>'">
									<div class="img-noticia noticia_flex" style="background-image:url(<?php echo $data_ciencia->list[$i]->img_social; ?>)">
									</div>
								</div>
								<br />
								<h2 class="titol h6"><a href="/noticia/<?php echo $data_ciencia->list[$i]->id; ?>/<?php echo $data_ciencia->list[$i]->title_url; ?>"><?php echo $data_ciencia->list[$i]->title; ?></a></h2>
