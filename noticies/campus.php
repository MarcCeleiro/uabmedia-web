...
<html lang="ca">
	...
	<head>
		...
		<title>Notícies del Campus - Actualitat - UABmèdia</title>
		...
		<meta name="twitter:url" content="https://uab.media/noticies/universitat-autonoma">
		<meta property="og:site_name" content="UABmèdia" />
		<meta property="og:url" content="https://uab.media/noticies/universitat-autonoma" />
		...
		<link rel="canonical" href="https://uab.media/noticies/universitat-autonoma">
					...
					<div class="row">
						<div class="col-12 overflow-hidden ">
							<div class="um-capcalera d-flex align-items-center">
								<h1 class="titol-principal titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies del Campus</h1>
							</div>
						</div>
						<section> 
							<div class="container">
								<div class="row">
									...
									<div class="col-4 amaga-mobil" style="margin-bottom: 2%;padding-left:0!important;" >
										<nav class="navbar navbar-expand-lg text-light">
											...
											<div class="collapse navbar-collapse text-light show" id="navbarNavDropdown">
												<ul class="navbar-nav">
...
<br />
						...
						<div data-aos="zoom-in" class="row">
							...
							<div class="col-12 col-md-4">
								<div class="bloc-imatges position-relative clicable" onclick="window.location= '/noticia/<?php echo $data_uab->list[$i]->id; ?>/<?php echo $data_uab->list[$i]->title_url; ?>'">
