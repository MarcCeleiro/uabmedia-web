...
<html lang="ca">
	...
	<head>
		...
		<title>Notícies de Salut - Actualitat - UABmèdia</title>
		...
		<meta name="twitter:url" content="https://uab.media/noticies/salut">
		<meta property="og:site_name" content="UABmèdia" />
		<meta property="og:url" content="https://uab.media/noticies/salut" />
		...
		<link rel="canonical" href="https://uab.media/noticies/salut">
		...
		<div class="contingut">
			<div class="container">
				<section id="header">
					<div class="row">
						<div class="col-12 overflow-hidden amaga-mobil">
							<h1 class="titol-pagina">Notícies de salut</h1>
						</div>
						<section> 
							<div class="container">
								<div class="row">
				...
				<section>
					...
					?>
					<div>
						<a href="noticies/salut.php"></a><br />
						<div data-aos="zoom-in" class="row">
							...
							?>
							<a class="col-12 col-md-4 noticia-petita" href="/noticia/<?php echo $data_salut->list[$i]->id; ?>/<?php echo $data_salut->list[$i]->title_url; ?>">
								<img class="imatge-destacada" src="<?php echo $data_salut->list[$i]->img_poster; ?>" alt="<?php echo $data_salut->list[$i]->title; ?>">
								<div class="contingut-noticia">
									<h2 class="titol"><?php echo $data_salut->list[$i]->title; ?></h2>
									<p class="data"><?php echo substr($data_salut->list[$i]->date_formatted, 0, -9); ?></p>
								</div>
							</a>
							<?php } ?>
